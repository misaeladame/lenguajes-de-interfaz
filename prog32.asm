...
;usuario 
;Se toma como base el prog31.asm y ahora se cambia el limite de la tabla
...
.DATA
	...
	vUniSuma	DB 00h
	vNum		DB 00h
	cLimite		DB 0Ah, 'Ingrese el limite de la tabla: $'
	vLim		DB 00h
...
.CODE
	inicio: 
		...
		eTabla:
			mov ah, 02h				;se manda un <ENTER> para mostrar
			mov dl, 0Ah				;la tabla por renglones
			int 21h
